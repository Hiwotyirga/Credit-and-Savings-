...
<body>
    ...
    <div class="container">
        ...
        <div class="card-body">
            <form action="creditaccadmin.php" method="POST">
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['deposit'])){
        ...
        if(isset($_POST['deposit'])){
            ...
            if($dept <0){
                ...
                echo 'window.location.href = "creditaccadmin.php"';
                echo '</script>';
            }
            elseif($dept ==0){
                echo '<script type = "text/javascript">';
            ...
            elseif($dept >(-1)*$camount){
                ...
                $newamt = $camount + $dept; //actually deposite for credit not saving.
                ...
                if($query){
                    // echo 'Entry Successfull';
                    header("Location:creditaccadmin.php");
                }
                else {
                    echo '<script type = "text/javascript">';
